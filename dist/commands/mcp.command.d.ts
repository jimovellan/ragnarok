 ...
 */
export declare function registerMcpCommand(program: Command, repository: KnowledgeRepository, docRepository: DocRepository, docChunkRepository: DocChunkRepository): void;
