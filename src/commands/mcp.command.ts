    ...
    program
        ...
        .action(async () => {
            ...
            server.registerTool(
                ...
                {
                    description:
                        'Explains what this MCP server is and how to use its tools together. Call this first if you are unsure what this server does.',
                    inputSchema: {},
                },
                async () => {
                    const about = [
                ...
                'search_knowledge',
                {
                    ...
                    inputSchema: {
                        ...
                        namespace: z.string().optional().describe(
                            'Filter by namespace, a logical grouping for knowledge entries (e.g. a project, team, or any other category you use to organize them). Call list_namespaces to see the available values.',
                        ),
                    },
                },
            ...
            server.registerTool(
                ...
                {
                    description:
                        'List every distinct namespace currently used to group knowledge entries, with no repetition. Use this to discover valid values for the namespace filter on search_knowledge.',
                    inputSchema: {},
                },
                async () => {
            ...
            server.registerTool(
                ...
                {
                    description:
                        'List every distinct tag currently used across knowledge entries, with no repetition. Use this to discover valid values for the tag filter on search_knowledge.',
                    inputSchema: {},
                },
                async () => {
            ...
            server.registerTool(
                ...
                {
                    description:
                        'Fetch the full knowledge entry (including content) for a given key. Use this after search_knowledge to load the full record behind a result.',
                    inputSchema: {
            ...
            server.registerTool(
                ...
                {
                    description:
                        'Create a new knowledge entry. Search_knowledge first to make sure the topic is not already ' +
                    ...
                    inputSchema: {
                        ...
                        namespace: z.string().optional().default('').describe(
                            'Logical grouping for the entry (e.g. a project, team, or any other category you use to organize them)',
                        ),
                        reference: z.string().optional().default('').describe(
                            'Pointer to the original source (e.g. a URL or file path), when this entry mirrors external content',
                        ),
                        storeContent: z.boolean().optional().default(true).describe(
                            'Whether to persist content as-is. Set false when content is only used to generate the embedding ' +
            ...
            server.registerTool(
                ...
                {
                    description:
                        'Update a knowledge entry by key. Only the fields provided are changed; omitted fields keep their current value. Title, summary, and content changes automatically refresh the embedding used for search.',
                    inputSchema: {
                        ...
                        storeContent: z.boolean().optional().describe(
                            'New storeContent flag. Setting this to false clears any previously persisted content.',
                        ),
            ...
            server.registerTool(
                ...
                {
                    description:
                        'Search docs by title/summary/tag/content relevance. Returns doc metadata only — use ' +
            ...
            server.registerTool(
                ...
                {
                    description:
                        'Semantic + keyword search directly over doc content chunks. Returns the matched chunk text ' +
            ...
            server.registerTool(
                ...
                {
                    description:
                        'List every distinct tag currently used across docs, with no repetition. Use this to discover valid values for the tag filter on search_docs/search_doc_content.',
                    inputSchema: {},
                },
                async () => {
            ...
            server.registerTool(
                ...
                {
                    description:
                        'Fetch doc metadata for a given key. Use search_doc_content to see the doc\'s actual content.',
                    inputSchema: {
            ...
            server.registerTool(
                ...
                {
                    description:
                        'Create a new doc. Content is split into chunks and embedded, not stored verbatim — the doc ' +
                    ...
                    inputSchema: {
                        ...
                        summary: z.string().optional().default('').describe('Compact abstract, about 2-3 lines'),
                        tag: z.string().optional().default('').describe('Free-form label'),
                        docReference: z.string().optional().default('').describe(
                            'Pointer to the original source (e.g. a URL)',
                        ),
            ...
            server.registerTool(
                ...
                {
                    description:
                        'Update a doc by key. Only the fields provided are changed. Passing content re-chunks and ' +
