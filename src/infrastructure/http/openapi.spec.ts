    ...
    paths: {
      ...
      "/api/knowledge": {
        ...
        post: {
          ...
          description:
            "Create a new knowledge entry. Search first to check the topic is not already covered — " +
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    storeContent: {
                      ...
                      default: true,
                      description:
                        "Whether to persist content as-is. Set false when content is only used to generate the " +
      ...
      "/api/docs": {
        get: {
          summary: "Search docs",
          description:
            "Hybrid semantic + keyword search over each doc's title/tag/summary/content. Returns doc metadata " +
        ...
        post: {
          summary: "Create doc",
          description:
            "Create a new doc. Content is split into chunks and embedded, not stored verbatim — the doc row " +
      ...
      "/api/docs/content": {
        get: {
          ...
          description:
            "Semantic + keyword search directly over doc content chunks. Returns the matched chunk text plus " +
      ...
      "/api/docs/{key}": {
        ...
        patch: {
          ...
          description:
            "Only the fields provided are changed. Passing content re-chunks and re-embeds it, replacing all of " +
